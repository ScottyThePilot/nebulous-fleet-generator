...
pub struct Component {
  ...
  pub compounding: Option<CompoundingCostClass>,
...
impl Component {
  ...
  pub const fn cost(self, socket_size: Size) -> Option<usize> {
    let tiling_quantity = self.tiling_quantity(socket_size);
    if tiling_quantity == 0 { None } else { Some(self.point_cost * tiling_quantity) }
  }
...
impl CompoundingCostClass {
  pub const fn first_instance_free(self) -> bool {
    match self {
      Self::Berthing | Self::Magazine => true,
      _ => false
    }
  }
  ...
  pub const fn multiplier(self) -> usize {
    match self {
      Self::CIC => 1,
      Self::Magazine => 0,
      Self::AuxiliarySteering => 1,
      Self::Berthing => 0,
      Self::DamageControlComplex => 3,
      Self::MineLayer => 2,
    }
  }
}
...
pub mod list {
  ...
  pub const AUXILIARY_STEERING: Component = Component {
    ...
    faction: None,
    compounding: Some(CompoundingCostClass::AuxiliarySteering),
    point_cost: 10,
    mass: 10.0,
    size: Size::new(3, 1, 3),
    power: 0,
  ...
  pub const BASIC_CIC: Component = Component {
    ...
    faction: None,
    compounding: Some(CompoundingCostClass::CIC),
    point_cost: 10,
    mass: 15.0,
    size: Size::new(4, 1, 6),
    power: 0,
  ...
  pub const BERTHING: Component = Component {
    ...
    faction: None,
    compounding: Some(CompoundingCostClass::Berthing),
    point_cost: 1,
    mass: 0.5,
    size: Size::new(1, 1, 1),
    power: 0,
  ...
  pub const BULK_MAGAZINE: Component = Component {
    ...
    faction: None,
    compounding: Some(CompoundingCostClass::Magazine),
    point_cost: 1,
    mass: 1.0,
    size: Size::new(1, 1, 1),
    power: 0,
  ...
  pub const DAMAGE_CONTROL_COMPLEX: Component = Component {
    ...
    faction: Some(Faction::Protectorate),
    compounding: Some(CompoundingCostClass::DamageControlComplex),
    point_cost: 80,
    mass: 20.0,
    size: Size::new(6, 3, 6),
    power: 0,
  ...
  pub const ML9_MINE_LAUNCHER: Component = Component {
    ...
    variant: None,
    faction: Some(Faction::Protectorate),
    compounding: Some(CompoundingCostClass::MineLayer),
    point_cost: 10,
    mass: 7.5,
    size: Size::new(3, 2, 3),
    power: -100,
